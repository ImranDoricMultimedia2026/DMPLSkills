...
export const companyData: CompanyInfo = {
  ...
  approach: [
    'Need-Based Curriculum Mapping: Programs structured around regional economic demand and verified skill requirements.',
    'Pedagogy of Practice: 70% hands-on practical lab learning balanced with foundational cognitive and domain theory.',
    'Institutional Compliance: Strict adherence to curriculum standardization, attendance discipline, and evaluation norms.',
    'Holistic Employability: Integrated soft-skills, workplace ethics, digital literacy, and interview readiness modules.',
    'Continuous Assessment: Formative milestones, practical viva examinations, and industry-oriented capstone tasks.'
  ],
  expertise: [
    'Government-Aligned Skill Development Initiatives',
    'Vocational & Technical Training Execution',
    'Institutional & Corporate Social Responsibility (CSR) Projects',
    'Digital Literacy & Modern Technology Skilling',
    'Retail, Services & Office Automation Programs',
    'Trainer Enablement & Quality Assurance Audits'
  ],
  timeline: [
    {
      year: 'Foundational Phase',
      title: 'Institutional Inception',
      detail: 'Formed with a core commitment to providing structured vocational and skill education aligned with India\'s evolving economic landscape.'
    },
    {
      year: 'Curriculum Expansion',
      title: 'Multidisciplinary Program Design',
      detail: 'Established practical course frameworks across digital tools, office administration, retail operations, and service vocations.'
    },
    {
      year: 'Ecosystem Alignment',
      title: 'Government & National Ecosystem Engagement',
      detail: 'Focused on aligning learning methodologies with national qualification frameworks and institutional training standards.'
    },
    {
      year: 'Current & Future Roadmap',
      title: 'District Outreach & Scalable Training Nodes',
